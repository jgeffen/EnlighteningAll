...
;(function($, doc, win){
    ...
    var Photobox, photobox, options, images=[], imageLinks, activeImage = -1, activeURL, lastActive, activeType, prevImage, nextImage, thumbsStripe, docElm, APControl, changeImage,
        ...
        overlay =   $('<div id="pbOverlay">').append(
                        ...
                        closeBtn = $('<a href="javascript:void(0)" id="pbCloseBtn" title="Close Photo Gallery Pop Up">').on('click', close)[0],
                        prevBtn = $('<a href="javascript:void(0)" id="pbPrevBtn" class="prevNext" title="Previous Slide"><b></b></a>').on('click', next_prev),
                        nextBtn = $('<a href="javascript:void(0)" id="pbNextBtn" class="prevNext" title="Next Slide"><b></b></a>').on('click', next_prev),
        ...
        return{
            ...
            generate : function(){
                ...
                for( i = 0; i < len; i++ ){
                    ...
                    elements.push('<li'+ type +'><a href="'+ link.href +'"><img src="'+ thumbSrc +'" alt="" alt="'+ title +'" /></a></li>');
                };
    ...
    function showContent(firstTime){
        ...
        function show(){
            ...
            if( activeType == 'video' ){
                ...
                image.prop({ 'src':activeURL, 'class':'prepare', 'alt':images[activeImage][1] });
