					...
					<div class="col">
						<div class="card">
							...
							<div class="card-body pt-3">
								...
								<?php if(!$member->getCheckIn()): ?>
									<img class="img-fluid mb-0" src="<?php echo $member->qrCode()->getCheckIn()->generate()?->getDataUri(); ?>">
								<?php else: ?>
									<p class="text-center">You are already checked in.</p>
								<?php endif; ?>
							</div>
						</div>
					</div>
