	...
	*/
	...
	try {
		...
		$json_response = match ($status) {
			...
			Statuses\Friend::APPROVED  => $member->friend($friend)->setAction(Requests\Friend::REMOVE)->execute() ? array(
				'status'  => 'success',
				'message' => 'Friend removed.'
			) : array(
				'status'  => 'error',
				'message' => 'Failed to cancel request friend. Please refresh your page.'
			)
		};
