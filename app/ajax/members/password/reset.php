<?php
	...
	*/
	...
	try {
		...
		// Set Member
		$member = Membership::FromHash(filter_input(INPUT_POST, 'hash'), FALSE);
		...
		$mailer->setBody('members/password/reset/notification.twig', array(
		...
		$json_response = array(
			'status' => 'success',
			'html'   => Template::Render('members/password/reset/success.twig')
		);
