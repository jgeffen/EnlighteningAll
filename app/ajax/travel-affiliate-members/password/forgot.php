...
try {
	...
	// Set Member
	$member = TravelAffiliateMembership::FromEmail(filter_input(INPUT_POST, 'email', FILTER_VALIDATE_EMAIL));
	...
	$mailer->setBody('travel-affiliate-members/password/forgot/notification.twig', array(
	...
	$json_response = array(
		'status' => 'success',
		'html'   => Template::Render('travel-affiliate-members/password/forgot/success.twig', array(
