...
try {
    ...
    // Update Database
    Database::Action("DELETE FROM `affiliate_paid_transactions` WHERE `transaction_id` = :transaction_id", array(
    ...
    $json_response = array(
        'status' => 'success',
        'message' => 'affiliate_paid_transations table has been updated successfully by deleting a paid transaction',
    );
