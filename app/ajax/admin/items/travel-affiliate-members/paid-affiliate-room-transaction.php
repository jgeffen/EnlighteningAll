...
try {
    ...
    // Update Database
    Database::Action(
        "UPDATE `affiliate_room_transactions` SET `is_paid` = :is_paid WHERE `id` = :id",
        array(
    ...
    $json_response = array(
        'status' => 'success',
        'message' => 'affiliate_room_transations table has been updated successfully with admin paid',
    );
