...
try {
    ...
    Database::Action("UPDATE `affiliate_paid_transactions` SET `payment_method` = :payment_method WHERE `transaction_id` = :transaction_id", array(
    ...
    $json_response = array(
        'status' => 'success',
        'message' => 'affiliate_paid_transations table has been updated successfully by adding the payment_method',
    );
