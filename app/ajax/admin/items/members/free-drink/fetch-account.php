<?php
	...
	*/
	...
	try {
		...
		// Check Member
		if($qr_code->getMember()->getFreeDrink()) throw new Exception('Member already received free drink this month.');
		...
		$json_response = array(
			...
			'html'   => Template::Render('admin/items/members/free-drink/account.twig', array(
