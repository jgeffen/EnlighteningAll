...
<h3><?php echo $subjects['failure']; ?></h3>
...
<b>Failure Reasons</b>
<p>Payment Status: <?php echo $form_values['payment_status']; ?></p>
<p>Response: <?php echo $form_values['response']; ?></p>
<p>Response Code: <?php echo $form_values['response_code']; ?></p>
<p>Response Text: <?php echo $form_values['response_text']; ?></p>

<hr>

<b>Please log into the admin panel to view further details.</b>
