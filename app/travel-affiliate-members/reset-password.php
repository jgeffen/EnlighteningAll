...
// Variable Defaults
$member = Database::Action("SELECT * FROM `travel_affiliate_members` WHERE MD5(CONCAT(`email`, '-PASS')) = :hash", array(
	'hash' => $dispatcher->getOption('hash')
))->fetchObject(TravelAffiliateMembership::class);
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-sm-10 col-md-10 col-xl-8">
				<h1 class="sr-only">Test Reset Password</h1>
	...
	$(function() {
		...
		$.when(
			...
			ajaxForm.on('submit', 'form', function(event) {
				...
				// Handle Ajax
				$.ajax('/ajax/travel-affiliate-members/password/reset', {
