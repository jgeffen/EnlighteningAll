			...
			<div class="col">
				...
				<?php foreach (array_reverse($groupedTransactions, true) as $yearMonth => $types) { ?>
					...
					<?php if (!empty($types['events'])) { ?>
						...
						<h3>Pending Event/Ticket Commission Total: $<?php echo $total_commission; ?></h3>
					...
					<?php if (!empty($types['rooms'])) { ?>
						...
						<h3>Pending Room Commission Total: $<?php echo $total_commission; ?></h3>

					<?php } ?>

					<br />

					<h2>Total Pending Commission for <?php echo htmlspecialchars($yearMonth); ?>: $<?php echo $events_total_commission + $rooms_total_commission; ?></h2>
