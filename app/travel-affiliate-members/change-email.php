...
// TODO: Attach change email to AJAX
// TODO: Only allowed members logged in
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-sm-10 col-md-8 col-lg-7 col-xl-6">
				<h1 class="sr-only">Change Email</h1>
				...
				<div role="form" class="title-bar-trim-combo">
					...
					<div id="change-email-form" class="form-wrap trim p-sm-5">
						<form>
							<?php
...
<script>
	$(function() {
		...
		var ajaxForm = $('#change-email-form');
		var captcha = $('#captcha');
		...
		$.when(
			...
			ajaxForm.on('submit', 'form', function(event) {
				...
				// Handle Ajax
				$.ajax('/ajax/travel-affiliate-members/change-email.php', {
