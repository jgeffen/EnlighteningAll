...
<main class="page-content">
	<section id="view-table" role="region">
		<div id="page-title-btn">
			...
			<a class="btn btn-primary" href="/user/add/galleries">
				<i class="fa fa-plus"></i>
				<span class="d-none d-sm-inline">Add Gallery</span>
			</a>
		</div>
				...
				details: {
					display: $.fn.dataTable.Responsive.display.modal({
						header: function(row) {
							...
							return 'Details for Gallery ID #' + data.id;
						}
					}),
						...
						switch(action) {
							case 'delete':
								...
								if(confirm('Are you sure you want to delete this?')) {
									// Handle Ajax
									$.ajax('/user/delete/galleries/' + data.item.id, {
										dataType: 'json',
										method: 'delete',
										async: true,
