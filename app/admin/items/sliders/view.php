...
<main class="page-content">
	<section id="view-table" role="region">
		<div id="page-title-btn">
			...
			<a class="btn btn-primary" href="/user/add/sliders">
				<i class="fa fa-plus"></i>
				<span class="d-none d-sm-inline">Add Slide</span>
			</a>
		</div>
	...
	$(function() {
		...
		tableElement.DataTable({
			...
			columns: [
				...
				{ data: 'slide', className: 'all no-drag' },
				...
				details: {
					display: $.fn.dataTable.Responsive.display.modal({
						header: function(row) {
							...
							return 'Details for Slider ID #' + data.id;
						}
					}),
						...
						switch(action) {
							case 'delete':
								...
								if(confirm('Are you sure you want to delete this?')) {
									// Handle Ajax
									$.ajax('/user/delete/sliders/' + data.item.id, {
										dataType: 'json',
										method: 'delete',
										async: true,
