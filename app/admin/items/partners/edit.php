<?php
	...
	*/
	...
	// Set Item
	$item = Secrets\Partner::Fetch(Database::Action("SELECT * FROM `partners` WHERE `id` = :table_id", array(
...
<script>
	$(function() {
		...
		$('#image-uploader-wrapper').uploader({
			...
			additionalData: { table_name: 'partners', title: 'Banner', column: 'filename', item: item },
