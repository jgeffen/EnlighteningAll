		...
		<form class="form-horizontal content-module">
			<div class="form-group">
				...
				<div class="feedback-wrap">
					<input id="table-name" class="form-control" type="text" maxlength="32" value="<?php echo $item->getEncoded('table_name'); ?>" readonly>
				</div>
			</div>
			
			<div class="form-group">
				<input id="item" class="form-control" type="text" name="item" maxlength="32" hidden>
				<label for="name-input">Category Name</label>
				
				<div class="feedback-wrap">
					<input id="name-input" class="form-control" type="text" name="name" maxlength="255" value="<?php echo $item->getEncoded('name'); ?>">
				</div>
			</div>
								...
								<?php foreach($image_sizes as $type => $format): ?>
									<div class="col-lg-6 col-xl-4">
										<a class="image-cropper-crop" href="#" data-cropper-action="crop">
											...
											<img class="img-fluid"
												src="<?php echo sprintf("/files/categories/%s/%s?v=%d", $type, $item->getFilename(), time()); ?>"
			...
			<div class="form-btns text-right">
				<div class="float-lg-right">
					...
					<a class="btn btn-danger btn-block-md ml-lg-1 mb-2" href="/user/view/categories">
...
<script>
	$(function() {
		...
		$('#image-cropper-wrapper').cropper({
			...
			additionalData: { table_name: 'categories', sizes: imageSizes, column: 'filename', item: item },
			...
			$.ajax({
				...
				success: function(response) {
					...
					switch(response.status) {
						case 'success':
							location.href = '/user/view/categories';
							break;
						case 'error':
