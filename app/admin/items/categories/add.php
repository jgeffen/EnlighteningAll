<?php
	...
	*/
	...
	// Set Table Names
	$table_names = Database::Action("SELECT `table_name`, `table_title` FROM `table_settings` WHERE `categories` IS TRUE ORDER BY `table_title`")->fetchAll(PDO::FETCH_COLUMN | PDO::FETCH_UNIQUE);
		...
		<form class="form-horizontal content-module">
			<div class="form-group">
				...
				<div class="select-wrap form-control">
					<select id="table-name" name="table_name">
						<?php foreach($table_names as $value => $label): ?>
			...
			<div class="form-group">
				...
				<div class="feedback-wrap">
					<input id="name-input" class="form-control" type="text" name="name" maxlength="255">
				</div>
			</div>
...
<script>
	$(function() {
		...
		$('#image-cropper-wrapper').cropper({
			...
			additionalData: { table_name: 'categories', sizes: imageSizes }
		});
