...
<main class="page-content">
	<section id="view-table" role="region">
		<div id="page-title-btn">
			...
			<a class="btn btn-primary" href="/user/add/member-faqs">
	...
	$(function() {
		...
		tableElement.DataTable({
			...
			columns: [
				...
				{ data: { _: 'item.question', display: 'question' }, className: 'all' },
				{ data: { _: 'item.answer', display: 'answer' }, className: 'all' },
						...
						switch(action) {
							case 'delete':
								...
								if(confirm('Are you sure you want to delete this?')) {
									// Handle Ajax
									$.ajax('/user/delete/member-faqs/' + data.item.id, {
										dataType: 'json',
										method: 'delete',
										async: true,
