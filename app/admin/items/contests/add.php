	...
	<div id="ajax-wrapper">
		<form class="form-horizontal content-module">
			...
			<div class="form-group">
				...
				<div class="feedback-wrap">
					<input id="date-start" class="form-control" type="text" name="date-start">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="feedback-wrap">
					<input id="date-end" class="form-control" type="text" name="date-end">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="select-wrap form-control">
					<select id="number-of-winners" name="number-of-winners">
...
<script>
	$(function() {
		...
		$('#image-cropper-wrapper').cropper({
			...
			additionalData: { table_name: 'contests', sizes: imageSizes }
		});
