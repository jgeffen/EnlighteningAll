<?php
	...
	*/
	...
	// Variable Defaults
	$page_title = 'Edit Event Package';
	
	// Set Item
	$item = Items\Events\Package::Fetch(Database::Action("SELECT * FROM `event_packages` WHERE `id` = :table_id", array(
		...
		<form class="form-horizontal content-module">
			<div class="form-group">
				...
				<div class="feedback-wrap">
					<input id="name" class="form-control" type="text" name="name" maxlength="255" value="<?php echo $item->getEncoded('name'); ?>">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="feedback-wrap">
					<div class="input-group">
						...
						<input id="price" class="form-control" type="text" name="price" data-format="number" value="<?php echo $item->getEncoded('price'); ?>">
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="select-wrap form-control">
					<select id="taxable" name="taxable" data-value="<?php echo (int)$item->isTaxable(); ?>">
			...
			<div class="form-group">
				...
				<div class="select-wrap form-control">
					<select id="is_bogo" name="is_bogo" data-value="<?php echo (int)$item->isBogo(); ?>">
						<?php foreach(array(1 => 'Yes', 0 => 'No') as $value => $label): ?>
							<option value="<?php echo $value; ?>">
								<?php echo $label; ?>
							</option>
			...
			<div class="form-group">
				<label for="musical">Musical Event?</label>
				
				<div class="select-wrap form-control">
					<select id="musical" name="musical" data-value="<?php echo (int)$item->isMusical(); ?>">
						<?php foreach(array(1 => 'Yes', 0 => 'No') as $value => $label): ?>
							<option value="<?php echo $value; ?>">
								<?php echo $label; ?>
							</option>
			...
			<div class="form-group">
				...
				<div class="select-wrap form-control">
					<select id="seatable" name="seatable" data-value="<?php echo (int)$item->isSeatable(); ?>">
						<?php foreach(array(1 => 'Yes', 0 => 'No') as $value => $label): ?>
							<option value="<?php echo $value; ?>">
								<?php echo $label; ?>
							</option>
			...
			<div class="form-group">
				...
				<div class="select-wrap form-control">
					<select id="stock-quantity" name="stock-quantity" data-value="<?php echo (int)$item->getStockQuantity(); ?>">
						<?php foreach(array_combine(range($item->getSoldQuantity(), $item->getSoldQuantity() + 100), range(0, 100)) as $value => $label): ?>
							<option value="<?php echo $value; ?>">
								<?php echo $label; ?>
							</option>
						<?php endforeach; ?>
			...
			<div class="form-group">
				...
				<div class="select-wrap form-control">
					<select id="merchant" name="merchant" data-value="<?php echo $item->getMerchant(); ?>">
