	...
	$(function() {
		...
		tableElement.DataTable({
			...
			columns: [
				...
				{ data: 'table_name', className: 'desktop' },
				{ data: 'table_id', className: 'desktop' },
				{ data: 'filename', className: 'desktop' },
				{ data: 'user_agent', className: 'desktop' },
				{ data: { _: 'ip_address', display: 'ip_address_display' }, className: 'desktop' },
				{ data: 'timestamp', className: 'desktop' }
			],
			responsive: {
				details: {
