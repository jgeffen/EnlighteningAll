...
<main class="page-content">
	<section id="view-table" role="region">
		<div id="page-title-btn">
			...
			<a class="btn btn-primary" href="/user/add/staff">
				<i class="fa fa-plus"></i>
				<span class="d-none d-sm-inline">Add Staff Member</span>
			</a>
		</div>
	...
	$(function() {
		...
		tableElement.DataTable({
			...
			columns: [
				...
				{ data: { _: 'item.full_name', display: 'full_name' }, className: 'all' },
				{ data: { _: 'item.job_title', display: 'job_title' }, className: 'all' },
				...
				details: {
					display: $.fn.dataTable.Responsive.display.modal({
						header: function(row) {
							...
							return 'Details for Staff Member ID #' + data.id;
						}
					}),
						...
						switch(action) {
							case 'delete':
								...
								if(confirm('Are you sure you want to delete this?')) {
									// Handle Ajax
									$.ajax('/user/delete/staff/' + data.item.id, {
										dataType: 'json',
										method: 'delete',
										async: true,
