		...
		<form class="form-horizontal content-module">
			...
			<div class="form-group">
				...
				<div class="feedback-wrap">
					<input id="full-name" class="form-control" type="text" name="full-name" maxlength="128">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="feedback-wrap">
					<input id="job-title" class="form-control" type="text" name="job-title" maxlength="128">
				</div>
			</div>
...
<script>
	$(function() {
		...
		$('#image-cropper-wrapper').cropper({
			...
			additionalData: { table_name: 'staff', sizes: imageSizes }
		});
