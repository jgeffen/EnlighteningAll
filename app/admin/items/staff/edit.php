<?php
	...
	*/
	...
	// Set Item
	$item = Items\Staff::Fetch(Database::Action("SELECT * FROM `staff` WHERE `id` = :table_id", array(
...
<main class="page-content">
	...
	<div id="ajax-wrapper">
		<form class="form-horizontal content-module">
			...
			<div class="form-group">
				<label for="page-full-name-input">Full Name</label>
				
				<div class="feedback-wrap">
					<input id="page-full-name-input" class="form-control" type="text" name="full-name" maxlength="128" value="<?php echo $item->getEncoded('full_name'); ?>">
				</div>
			</div>
			
			<div class="form-group">
				<label for="page-job-title-input">Job Title</label>
				
				<div class="feedback-wrap">
					<input id="page-job-title-input" class="form-control" type="text" name="job-title" maxlength="128" value="<?php echo $item->getEncoded('job_title'); ?>">
				</div>
			</div>
								...
								<?php foreach($image_sizes as $type => $format): ?>
									<div class="col-lg-6 col-xl-4">
										<a class="image-cropper-crop" href="#" data-cropper-action="crop">
											...
											<img class="img-fluid"
												src="<?php echo sprintf("/files/staff/%s/%s?v=%d", $type, $item->getFilename(), time()); ?>"
			...
			<div class="form-btns text-right">
				<div class="float-lg-right">
					...
					<a class="btn btn-danger btn-block-md ml-lg-1 mb-2" href="/user/view/staff">
...
<script>
	$(function() {
		...
		$('#image-cropper-wrapper').cropper({
			...
			additionalData: { table_name: 'staff', sizes: imageSizes, column: 'filename', item: item },
