		...
		<div class="row">
			<div class="col-12">
				...
				<?php foreach ($groupedTransactions as $yearMonth => $types) { ?>
					...
					<?php if (!empty($types['events'])) { ?>
						...
						<table class="table table-bordered nowrap w-100 dataTable no-footer dtr-inline">
							...
							<?php foreach ($types['events'] as $transaction) { ?>
								...
								$total_event_amount += htmlspecialchars($transaction['amount']);
						...
						<h3>Event/Ticket Total: $<?php echo $total_event_amount; ?></h3>
					...
					<?php if (!empty($types['rooms'])) { ?>
						...
						<table class="table table-bordered nowrap w-100 dataTable no-footer dtr-inline">
							...
							<?php foreach ($types['rooms'] as $transaction) { ?>
								...
								$total_room_amount += htmlspecialchars($transaction['amount']);
						...
						<h3>Room Total: $<?php echo $total_room_amount; ?></h3>
					...
					<h2>Approved Total for <?php echo htmlspecialchars($yearMonth); ?>: $<?php echo $total_event_amount + $total_room_amount; ?></h2>
