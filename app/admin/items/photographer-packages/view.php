<?php
	...
	*/
	...
	// Variable Defaults
	$page_title = 'View Photographer Packages';
...
<main class="page-content">
	<section id="view-table" role="region">
		<div id="page-title-btn">
			...
			<a class="btn btn-primary" href="/user/add/photographer-packages">
				...
				details: {
					display: $.fn.dataTable.Responsive.display.modal({
						header: function(row) {
							...
							return 'Details for Photographer Package ID #' + data.id;
						}
					}),
						...
						switch(action) {
							case 'delete':
								...
								if(confirm('Are you sure you want to delete this?')) {
									// Handle Ajax
									$.ajax('/user/delete/photographer-packages/' + data.item.id, {
										dataType: 'json',
										method: 'delete',
										async: true,
