	...
	<div id="ajax-wrapper">
		<form class="form-horizontal content-module">
			...
			<div class="form-group">
				...
				<div class="feedback-wrap">
					<input id="label-input" class="form-control" type="text" name="label" maxlength="255">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="select-wrap form-control">
					<select id="merchant" name="merchant">
						<?php foreach(Items\Product::FormOptions('merchants') as $value => $label): ?>
							<option value="<?php echo $value; ?>">
								<?php echo $label; ?>
							</option>
						<?php endforeach; ?>
			...
			<div class="form-group">
				...
				<select id="taxable" class="form-control" name="taxable">
					<?php foreach(array(0 => 'No', 1 => 'Yes') as $value => $label): ?>
						<option value="<?php echo $value; ?>">
							<?php echo $label; ?>
						</option>
					<?php endforeach; ?>
			...
			<div class="form-group">
				<label for="is_fridge">Fridge Item?</label>
				<select id="is_fridge" class="form-control" name="is_fridge">
					<?php foreach(array(0 => 'No', 1 => 'Yes') as $value => $label): ?>
						<option value="<?php echo $value; ?>">
							<?php echo $label; ?>
						</option>
			...
			<div class="form-group">
				...
				<select id="stock_quantity" class="form-control" name="stock_quantity">
					<?php foreach(array_combine(range(0, 1000), range(0, 1000)) as $value => $label): ?>
						<option value="<?php echo $value; ?>">
							<?php echo $label; ?>
						</option>
					<?php endforeach; ?>
			...
			<div class="form-btns text-right">
				<div class="float-lg-right">
					...
					<a class="btn btn-danger btn-block-md ml-lg-1 mb-2" href="/user/view/products">
...
<script>
	$(function() {
		...
		$('#image-cropper-wrapper').cropper({
			...
			additionalData: { table_name: 'products', sizes: imageSizes }
		});
