...
<main class="page-content test">
	<section id="view-table" role="region">
		...
		<div id="ajax-wrapper">
			...
			<form id="add_team_member" class="form-horizontal content-module">
				...
				<div class="form-btns text-right">
					<div class="float-lg-left">
						<button class="btn btn-success btn-block-md mb-2 team-member-save">
							<i class="fal fa-save"></i> Add Team Member
						</button>
					</div>
				</div>
				...
				<table id="data-table" class="table table-bordered" style="width:100%;">
					<thead>
						<tr>
							...
							<th class="text-nowrap">Team Member Query Link</th>
...
<script>
	$(function() {
		...
		$(this.body).on('submit', '#add_team_member', function(event) {
			...
			$.ajax({
				method: 'post',
				url: "/ajax/admin/items/travel-affiliate-members/create-team-member-account",
