<?php
	...
	*/
	...
	// Variable Defaults
	$page_title = 'Review Member Reports: Comments';
	
	// Set Item
	$item = Comments\Report::Init($dispatcher->getTableId());
	...
	<div id="ajax-wrapper">
		<form class="form-horizontal content-module">
			...
			<div class="form-group">
				...
				<div class="jumbotron py-1">
					<pre class="mb-0"><code><?php echo $item->getComment()?->getContent(); ?></code></pre>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="jumbotron py-1">
					<pre class="mb-0"><code><?php echo $item->getComment()?->getMember()?->getUsername(); ?></code></pre>
				</div>
			</div>
			...
			<div class="form-btns text-right">
				<div class="float-lg-right">
					...
					<a class="btn btn-danger btn-block-md ml-lg-1 mb-2" href="/user/view/member-reports/comments">
			...
			$.ajax({
				...
				success: function(response) {
					...
					switch(response.status) {
						case 'success':
							location.href = '/user/view/member-reports/comments';
							break;
						case 'error':
