	...
	$(function() {
		...
		tableElement.DataTable({
			...
			columns: [
				...
				{ data: { _: 'item.first_name', display: 'item.first_name' }, className: 'all' },
				{ data: { _: 'item.last_name', display: 'item.last_name' }, className: 'all' },
						...
						switch(action) {
							case 'delete':
								...
								if(confirm('Are you sure you want to delete this?')) {
									// Handle Ajax
									$.ajax('/user/delete/forms-intake/' + data.item.id, {
										dataType: 'json',
										method: 'delete',
										async: true,
