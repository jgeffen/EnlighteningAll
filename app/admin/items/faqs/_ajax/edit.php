<?php
	...
	*/
	...
	try {
		...
		// Update Database
		Database::Action("UPDATE `faqs` SET `category_id` = :category_id, `question` = :question, `answer` = :answer, `published` = :published, `published_date` = :published_date, `author` = :author, `user_agent` = :user_agent, `ip_address` = :ip_address WHERE `id` = :id", array(
