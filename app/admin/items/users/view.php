...
<main class="page-content">
	<section id="view-table" role="region">
		<div id="page-title-btn">
			...
			<a class="btn btn-primary" href="/user/add/users">
	...
	$(function() {
		...
		tableElement.DataTable({
			...
			columns: [
				...
				{ data: 'user_type', className: 'all' },
				{ data: 'name', className: 'all' },
				{ data: 'email', className: 'all' },
				{ data: { _: 'last_login.timestamp', display: 'last_login.display' }, className: 'all' },
				...
				details: {
					display: $.fn.dataTable.Responsive.display.modal({
						header: function(row) {
							...
							return 'Details for User ID #' + data.id;
						}
					}),
						...
						switch(action) {
							case 'delete':
								...
								if(confirm('Are you sure you want to delete this?')) {
									// Handle Ajax
									$.ajax('/user/delete/users/' + data.item.id, {
										dataType: 'json',
										method: 'delete',
										async: true,
