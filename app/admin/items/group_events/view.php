...
<main class="page-content">
	<section id="view-table" role="region">
		<div id="page-title-btn">
			...
			<a class="btn btn-primary" href="/user/add/group-events">
				...
				details: {
					display: $.fn.dataTable.Responsive.display.modal({
						header: function(row) {
							...
							return 'Details for Group Event ID #' + data.id;
						}
					}),
						...
						switch(action) {
							case 'delete':
								...
								if(confirm('Are you sure you want to delete this?')) {
									// Handle Ajax
									$.ajax('/user/delete/group-events/' + data.item.id, {
										dataType: 'json',
										method: 'delete',
										async: true,
