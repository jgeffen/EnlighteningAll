	...
	<div id="ajax-wrapper">
		<form class="form-horizontal content-module">
			...
			<div class="form-group">
				...
				<div class="feedback-wrap">
					<input id="name" class="form-control" type="text" name="name" maxlength="75">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="feedback-wrap">
					<input id="email" class="form-control" type="email" name="email" maxlength="75">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="feedback-wrap">
					<input id="phone" class="form-control" type="text" name="phone" maxlength="75" data-format="phone">
				</div>
			</div>
...
<script>
	$(function() {
		...
		$('#image-cropper-wrapper').cropper({
			...
			additionalData: { table_name: 'photographers', sizes: imageSizes }
		});
