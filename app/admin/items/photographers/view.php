...
<main class="page-content">
	<section id="view-table" role="region">
		<div id="page-title-btn">
			...
			<a class="btn btn-primary" href="/user/add/photographers">
				<i class="fa fa-plus"></i>
				<span class="d-none d-sm-inline">Add Photographer</span>
			</a>
		</div>
	...
	$(function() {
		...
		tableElement.DataTable({
			...
			columns: [
				...
				{ data: { _: 'item.name', display: 'name' }, className: 'all' },
				{ data: { _: 'item.content', display: 'content' }, className: 'all' },
				{ data: 'packages', className: 'all' },
						...
						switch(action) {
							case 'delete':
								...
								if(confirm('Are you sure you want to delete this?')) {
									// Handle Ajax
									$.ajax('/user/delete/photographers/' + data.item.id, {
										dataType: 'json',
										method: 'delete',
										async: true,
							...
							case 'view':
								// Handle Ajax
								$.ajax('/user/info/photographers/' + data.item.id, {
									dataType: 'html',
									method: 'get',
									async: false,
									beforeSend: showLoader,
