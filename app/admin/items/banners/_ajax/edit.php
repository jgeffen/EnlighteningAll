<?php
	...
	*/
	...
	try {
		...
		$item   = Items\Banner::Init($item['id']);
		...
		// Update Database
		Database::Action("UPDATE `banners` SET `label` = :label, `filename` = :filename, `author` = :author, `user_agent` = :user_agent, `ip_address` = :ip_address WHERE `id` = :id", array(
