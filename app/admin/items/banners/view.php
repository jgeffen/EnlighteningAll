...
<main class="page-content">
	<section id="view-table" role="region">
		<div id="page-title-btn">
			...
			<a class="btn btn-primary" href="/user/add/banners">
				<i class="fa fa-plus"></i>
				<span class="d-none d-sm-inline">Add Banner</span>
			</a>
		</div>
	...
	$(function() {
		...
		tableElement.DataTable({
			...
			columns: [
				...
				{ data: 'file', className: 'all' },
				{ data: 'label', className: 'all' },
				...
				details: {
					display: $.fn.dataTable.Responsive.display.modal({
						header: function(row) {
							...
							return 'Details for Banner ID #' + data.id;
						}
					}),
						...
						switch(action) {
							case 'delete':
								...
								if(confirm('Are you sure you want to delete this?')) {
									// Handle Ajax
									$.ajax('/user/delete/banners/' + data.item.id, {
										dataType: 'json',
										method: 'delete',
										async: true,
