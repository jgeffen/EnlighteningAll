<?php
	...
	*/
	...
	$packages = Database::Action(
		"SELECT `id`, CONCAT_WS(' ', `name`, CONCAT('($', FORMAT(`price`, 2), ')')) FROM `event_packages` WHERE `published` IS TRUE ORDER BY `name`, `price` DESC"
	)->fetchAll(PDO::FETCH_COLUMN | PDO::FETCH_UNIQUE);
	...
	<div id="ajax-wrapper">
		<form class="form-horizontal content-module">
			...
			<div class="form-group">
				...
				<div class="select-wrap form-control">
					<select id="class-type" name="class_type">
			...
			<div class="form-group">
				...
				<div class="feedback-wrap">
					<input id="event-dates" class="form-control" type="text" name="event_dates" placeholder="- None -">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="feedback-wrap">
					<input id="location" class="form-control" type="text" name="location" maxlength="75">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="feedback-wrap">
					<input id="price-text" class="form-control" type="text" name="price_text" maxlength="20">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="frame pb-4">
					<select id="event-packages-ids" name="event_package_ids[]" multiple>
			...
			<div class="form-collapse">
				<div id="advanced-options" class="collapse">
					<div class="form-group">
						<label for="accepting-rsvp">Allow Pay Later?</label>
						
						<div class="select-wrap form-control">
							<select id="accepting-rsvp" name="accepting_rsvp">
					...
					<div class="form-group">
						...
						<div class="select-wrap form-control">
							<select id="display-rsvps" name="display_rsvps">
								<?php foreach(array('No', 'Yes') as $value => $label): ?>
									<option value="<?php echo $value; ?>">
										<?php echo $label; ?>
									</option>
...
<script>
	$(function() {
		...
		$('#image-cropper-wrapper').cropper({
			...
			additionalData: { table_name: 'events', sizes: imageSizes }
		});
