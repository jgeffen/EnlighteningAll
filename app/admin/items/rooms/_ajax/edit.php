<?php
	...
	*/
	...
	try {
		...
		// Update Database
		Database::Action("UPDATE `rooms` SET `heading` = :heading, `content` = :content, `filename` = :filename, `filename_alt` = :filename_alt, `published` = :published, `published_date` = :published_date, `author` = :author, `user_agent` = :user_agent, `ip_address` = :ip_address WHERE `id` = :id", array(
