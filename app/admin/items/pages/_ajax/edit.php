<?php
	...
	*/
	...
	try {
		...
		$item     = Items\Page::Init((int)$item['id']);
		...
		// Set Route(s)
		$route        = Router\Route::Init('pages', $item->getId());
		$parent_route = Router\Route::Init('pages');
