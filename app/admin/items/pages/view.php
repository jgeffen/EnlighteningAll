...
<main class="page-content">
	<section id="view-table" role="region">
		<div id="page-title-btn">
			...
			<a class="btn btn-primary" href="/user/add/pages">
				<i class="fa fa-plus"></i>
				<span class="d-none d-sm-inline">Add Page</span>
			</a>
		</div>
				...
				details: {
					display: $.fn.dataTable.Responsive.display.modal({
						header: function(row) {
							...
							return 'Details for Page ID #' + data.id;
						}
					}),
						...
						switch(action) {
							case 'delete':
								...
								if(confirm('Are you sure you want to delete this?')) {
									// Handle Ajax
									$.ajax('/user/delete/pages/' + data.item.id, {
										dataType: 'json',
										method: 'delete',
										async: true,
