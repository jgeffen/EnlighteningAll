<?php
	...
	*/
	...
	// Variable Defaults
	$item = Items\Page::Init($dispatcher->getRoute()?->getTableId());
...
<div class="container-fluid main-content">
	<div class="container">
		<div class="row">
			<div class="col">
				<h1 class="title-underlined mb-4"><?php echo $item->getHeading(); ?></h1>
				...
				<?php if($item->getPDFs()): ?>
					<?php if(!empty($item->getContent()) || !empty($item->getYoutubeId())): ?>
						<hr class="clear my-5">
					<?php endif; ?>
