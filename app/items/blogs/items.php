<?php
	...
	*/
	...
	try {
		...
		$pagination->setQuery("SELECT * FROM `blogs` WHERE `published` IS TRUE ORDER BY `position` DESC");
		...
		$items     = $pagination->getItems(Items\Blog::class);
	...
	$page_title       = $pagination->formatPageString("Enlightening All™ Blog");
	$page_description = $pagination->formatPageString("Stay up to date with the latest from Enlightening All™");
		...
		<div class="row">
			<div class="col">
				<h1 class="title-underlined mt-0 mb-3 mb-md-4 d-inline-block w-100">
					<?php echo $pagination->formatPageString("Enlightening All™ Blog"); ?>
				</h1>
