<?php
	...
	*/
	...
	try {
		...
		$pagination->setQuery("SELECT * FROM `careers` WHERE `published` IS TRUE ORDER BY `position` DESC");
		...
		$items     = $pagination->getItems(Items\Career::class);
	...
	$page_title       = $pagination->formatPageString("Enlightening All™ Careers");
	$page_description = $pagination->formatPageString("Career Opportunities with Enlightening All™");
		...
		<div class="row">
			<div class="col">
				<h1 class="title-underlined mt-0 mb-3 mb-md-4 d-inline-block w-100">
					<?php echo $pagination->formatPageString("Enlightening All™ Careers"); ?>
				</h1>
