<?php
	...
	*/
	...
	try {
		...
		$pagination->setQuery("SELECT * FROM `groups` WHERE `published` IS TRUE ORDER BY `position` DESC");
		...
		$items     = $pagination->getItems(Items\Group::class);
	...
	$page_title       = $pagination->formatPageString("Enlightening All™ Groups and Takeovers");
	$page_description = $pagination->formatPageString("Groups to meet at Enlightening All™");
