                                ...
                                <div class="col-lg-6">
                                    ...
                                    <p>Credit/Debit Card Information</p>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                <select id="purchase-pass-form-select-cc-type" name="cc_type" class="form-control">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-3 text-lg-right pt-0 pt-lg-1" for="purchase-pass-form-input-cc-number">Card Number:</label>
                                            <div class="col-lg-9">
                                                <input id="purchase-pass-form-input-cc-number" class="form-control" name="cc_number" type="text" placeholder="* Required" maxlength="16">
                                            </div>
                                        </div>

                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-3 text-lg-right pt-0 pt-lg-1" for="purchase-pass-form-select-cc-expiry-month">Expiration:</label>
                                            <div class="col-lg-9">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <select id="purchase-pass-form-select-cc-expiry-month" name="cc_expiry_month" class="form-control">
                                                    ...
                                                    <div class="col-6">
                                                        <select id="purchase-pass-form-select-cc-expiry-year" name="cc_expiry_year" class="form-control">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-3 text-lg-right pt-0 pt-lg-1" for="purchase-pass-form-input-cc-cvv">CVV:</label>
                                            <div class="col-lg-9">
                                                <input id="purchase-pass-form-input-cc-cvv" class="form-control" name="cc_cvv" type="text" placeholder="* Required" maxlength="4">
                                            </div>
                                        </div>
                                    <?php else: ?>
                                        <!-- HIDDEN PLACEHOLDERS FOR FREE EVENTS -->
