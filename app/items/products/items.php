<?php
	...
	*/
	...
	try {
		...
		$pagination->setQuery("SELECT * FROM `products` WHERE `published` IS TRUE ORDER BY `position` DESC");
		...
		$items     = $pagination->getItems(Items\Product::class);
	...
	$page_title       = $pagination->formatPageString("Enlightening All™ Products");
	$page_description = $pagination->formatPageString("Enlightening All™ Products");
		...
		<div class="row">
			<div class="col">
				<h1 class="title-underlined mt-0 mb-3 mb-md-4 d-inline-block w-100">
					<?php echo $pagination->formatPageString("Our Products"); ?>
				</h1>
