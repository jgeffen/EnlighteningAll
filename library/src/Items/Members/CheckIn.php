<?php
	...
	*/
	...
	class CheckIn implements Interfaces\Item {
		use Traits\Item;
		
		protected Tables\Members $table = Tables\Members::CHECKINS;
		...
		public static function Init(?int $id): ?self {
			return Database::Action("SELECT * FROM `member_check_ins` WHERE `id` = :id", array(
				'id' => $id
