	...
	class Account implements Interfaces\Action {
		...
		private function update(): bool {
			...
			return match ($this->getColumn()) {
				Types\Column::PASSWORD => Database::Action("UPDATE `members` SET `password` = :password WHERE `id` = :identifier", array(
		...
		private function verify(): bool {
			...
			return Database::Action("UPDATE `members` SET `verified` = :verified WHERE `email` = :email", array(
