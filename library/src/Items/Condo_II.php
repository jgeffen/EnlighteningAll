<?php
	...
	*/
	...
	class Condo_II extends Abstracts\Listed {
		use Traits\Gallery, Traits\Image;
		
		protected Tables\Secrets $table = Tables\Secrets::CONDOS_II;
		...
		static function Init(?int $id): ?self {
			return Database::Action("SELECT * FROM `condos_ii` WHERE `id` = :id", array(
				'id' => $id
