<?php
	...
	*/
	...
	class GroupEvent extends Abstracts\PageType {
		use Traits\Category, Traits\Image, Traits\Gallery, Traits\PDFs;
		
		protected Tables\Website $table = Tables\Website::GROUP_EVENTS;
		...
		public static function Init(?int $id): ?static {
			return Database::Action("SELECT * FROM `group_events` WHERE `id` = :id", array(
				'id' => $id
		...
		public function getLink(): string {
			return sprintf("/group-events/%s", $this->getPageUrl());
		}
	}