<?php
	...
	*/
	...
	class Career extends Abstracts\PageType {
		use Traits\Category, Traits\Item, Traits\Gallery, Traits\Page, Traits\PDFs;
		
		protected Tables\Website $table = Tables\Website::CAREERS;
		...
		static function Init(?int $id): ?self {
			return Database::Action("SELECT * FROM `careers` WHERE `id` = :id", array(
				'id' => $id
