<?php
	...
	*/
	...
	class Blog extends Abstracts\PageType {
		use Traits\Category, Traits\Image, Traits\Gallery, Traits\PDFs;
		
		protected Tables\Website $table = Tables\Website::BLOGS;
		...
		public static function Init(?int $id): ?static {
			return Database::Action("SELECT * FROM `blogs` WHERE `id` = :id", array(
				'id' => $id
		...
		public function getLink(): string {
			return sprintf("/blogs/%s", $this->getPageUrl());
		}
	}