<?php
	...
	*/
	...
	class Staff extends Abstracts\PageType {
		use Traits\Category, Traits\Image, Traits\Gallery, Traits\PDFs;
		
		protected Tables\Website $table = Tables\Website::STAFF;
		...
		public static function Init(?int $id): ?static {
			return Database::Action("SELECT * FROM `staff` WHERE `id` = :id", array(
				'id' => $id
		...
		public function getLink(): string {
			return sprintf("/staff/%s", $this->getPageUrl());
		}
	}