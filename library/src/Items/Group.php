<?php
	...
	*/
	...
	class Group extends Abstracts\PageType {
		use Traits\Category, Traits\Image, Traits\Gallery, Traits\PDFs;
		
		protected Tables\Website $table = Tables\Website::GROUPS;
		...
		public static function Init(?int $id): ?static {
			return Database::Action("SELECT * FROM `groups` WHERE `id` = :id", array(
				'id' => $id
		...
		public function getLink(): string {
			return sprintf("/groups/%s", $this->getPageUrl());
		}
	}