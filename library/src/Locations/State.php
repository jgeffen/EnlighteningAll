<?php
	...
	*/
	...
	class State {
		...
		protected Tables\Location $table = Tables\Location::STATES;
		...
		public static function Init(?int $id): ?self {
			return Database::Action("SELECT * FROM `location_states` WHERE `id` = :id", array(
				'id' => $id
		...
		public function getCities(): array {
			return $this->cities ??= City::FetchAll(Database::Action("SELECT * FROM `location_cities` WHERE `state_id` = :id", array(
				'id' => $this->getId()
			)));
		}
