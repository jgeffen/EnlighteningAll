<?php
	...
	*/
	...
	class Shipping {
		 ...
		 */
		public function __construct(?string $address_line_1 = NULL, ?string $address_line_2 = NULL, ?string $city = NULL, ?string $company = NULL, ?string $country = NULL, ?string $email = NULL, ?string $fax = NULL, ?string $first_name = NULL, ?string $last_name = NULL, ?string $phone = NULL, ?string $state = NULL, ?string $zip_code = NULL) {
