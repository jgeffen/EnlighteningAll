<?php
	...
	*/
	...
	class Sponsor extends Abstracts\Listed {
		use Traits\Image;
		
		protected Tables\Swinkster $table = Tables\Swinkster::SPONSORS;
		...
		public static function Init(?int $id): ?self {
			return Database::Action("SELECT * FROM `swinkster_sponsors` WHERE `id` = :id", array(
				'id' => $id
