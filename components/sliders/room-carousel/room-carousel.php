...
<?php if($qd_item->getGallery()): ?>
	<section class="room-carousel-wrap <?php echo $classes; ?>" aria-label="Room Carousel">
				...
				<?php if($qd_item->hasImage()): ?>
					<div class="swiper-slide">
						<a href="<?php echo $qd_item->getImage(); ?>" title="<?php echo $qd_item->getFilenameAlt(); ?>">
							<img src="<?php echo $qd_item->getDefaultImage('landscape'); ?>" data-src="<?php echo $qd_item->getLandscapeImage(); ?>" alt="<?php echo $qd_item->getFilenameAlt(); ?>">
						</a>
					</div>
				<?php endif; ?>
					...
					<?php foreach($qd_item->getGallery() as $image): ?>
						<div class="swiper-slide">
							<a href="<?php echo $image['source']; ?>">
								<img src="<?php echo $qd_item->getDefaultImage('landscape'); ?>" data-src="<?php echo $image['featured']; ?>" alt="<?php echo $image['alt']; ?>">
							</a>
						</div>
					<?php endforeach; ?>
				<?php endif; ?>
		...
		<div class="swiper gallery-thumbs" aria-hidden="true">
			<div class="swiper-wrapper">
				<?php if(!empty($qd_item->hasImage())): ?>
					<div class="swiper-slide">
						<img src="<?php echo $qd_item->getDefaultImage('landscape'); ?>" data-src="<?php echo $qd_item->getLandscapeThumb(); ?>" alt="<?php echo $qd_item->getFilenameAlt(); ?>">
					</div>
				<?php endif; ?>
				...
				<?php if($qd_item->getGallery()): ?>
					<?php foreach($qd_item->getGallery() as $image): ?>
						<div class="swiper-slide">
							<img src="<?php echo $qd_item->getDefaultImage('landscape'); ?>" data-src="<?php echo $image['thumb']; ?>" alt="<?php echo $image['alt']; ?>">
						</div>
					<?php endforeach; ?>
				<?php endif; ?>
			</div>
